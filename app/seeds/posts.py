...
def seed_posts():
  ...
  xi_thankyou = Post(user_id=10, content="I offically announced that I have completed all 3 projects. Thank you for those who give me advice and feedback to improve my projects. Once again, thank you all for helping me to make high qulaity projects. Love you all!",
  ...
  lorem3 = Post(user_id=3, content="[Lorem Ipsum] Etiam eros magna, blandit non tincidunt ac, consectetur a dolor. Sed dignissim imperdiet dictum. Vivamus faucibus sed massa et pulvinar. Mauris bibendum laoreet est, eu fermentum sapien accumsan quis. ")
  lorem4 = Post(user_id=3, content="[Lorem Ipsum] Vestibulum congue a nisl ac pharetra. Etiam laoreet congue magna vitae mollis. Vestibulum pellentesque turpis et sapien mollis posuere. Phasellus malesuada, eros vitae facilisis gravida, risus nisl dictum nulla.")
  lorem5 = Post(user_id=8, content="[Lorem Ipsum] Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec ut dictum metus. Nunc pharetra mattis ante, id consectetur tellus rhoncus in. Fusce ornare, mauris in aliquam luctus.")
